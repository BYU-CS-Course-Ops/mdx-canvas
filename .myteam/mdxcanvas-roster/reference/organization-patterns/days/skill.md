---
skill: organization-patterns/days
---
...
- Scheduling content to open or close on a specific class session date
- Controlling when quizzes or assignments become available relative to lecture days
- Building day-level args tables for Jinja templates
- Understanding the `available_from` / `due_at` pattern for day-by-day content
...
All date/time attributes use this exact format: `MMM d, yyyy, h:mm AM/PM`
