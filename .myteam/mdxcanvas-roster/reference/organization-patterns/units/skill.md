---
skill: organization-patterns/units
---
...
- Understanding how a course is divided into major thematic blocks
- Naming or organizing unit directories under `content/`
- Defining unit-level variables in `global_args.yaml`
- Grouping Canvas modules by unit
...
Define unit-level metadata in `global_args.yaml`:
