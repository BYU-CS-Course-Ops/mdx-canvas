...
def main(api_url, api_token, course_id, time_zone: str, file_path: Path, args_path: Path, global_args_path: Path, line_id: str):
    print("-" * 50 + "\nCanvas MDX\n" + "-" * 50)

    post_document(get_course(api_url, api_token, course_id), time_zone, file_path, args_path, global_args_path, line_id)
