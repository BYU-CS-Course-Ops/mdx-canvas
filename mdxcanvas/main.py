...
def main(
    ...
    if result.has_deployed_content() and result.has_updated_quizzes():
        result.set_message("Successfully deployed the following content and updated the following quizzes...")

    elif result.has_deployed_content():
        result.set_message("Successfully deployed the following content...")

    elif result.has_updated_quizzes():
        result.set_message("Successfully updated the following quizzes...")
